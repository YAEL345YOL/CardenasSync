...
<head>
    ...
    <title>Agregar Contenedor/Cliente</title>
</head>
<body class="body--form body--main">
    <form class="form form--size1" action="../php/contenedor_cliente/agregar_contenedor_cliente.php" method="POST">
        <h2>Agregar Contenedor/Cliente</h2>
