...
$sql = "UPDATE viaje SET fecha_fin_viaje = '$fecha_fin', hora_fin_viaje = '$hora_fin', estado_viaje = '$estado',actualizacion_viaje = '$actualizaciones',id_muelle = '$id_muelle' WHERE id_viaje = '$id'";
